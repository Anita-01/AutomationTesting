...
WebUI.verifyElementPresent(findTestObject('BuyItem/VerifyOneItem'), 0)

//WebUI.click(findTestObject('BuyItem/ButtonBeli'))
//
//WebUI.click(findTestObject('BuyItem/ButtonBeli'))
WebUI.click(findTestObject('BuyItem/Kambing'))

WebUI.click(findTestObject('BuyItem/PayKambing'))
